 ...
 */
package org.foomo.zugspitze.as3.core
{
	 ...
	 */
	public class ZugspitzeMovieClipComponent extends MovieClip implements IApplication
	{
		//-----------------------------------------------------------------------------------------
		// ~ Variables
		//-----------------------------------------------------------------------------------------
		...
		public function ZugspitzeMovieClipComponent()
		{
			super();
